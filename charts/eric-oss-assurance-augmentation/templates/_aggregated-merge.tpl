...
*/ -}}
{{- define "eric-oss-assurance-augmentation.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-assurance-augmentation.mergeAnnotations" -}}
  {{- include "eric-oss-assurance-augmentation.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-assurance-augmentation.mergeLabels" -}}
  {{- include "eric-oss-assurance-augmentation.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
