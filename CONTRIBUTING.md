# Contributing to Assurance Augmentation will add fields onto DMM records. An augmentation registration will provide a reference to a service that will provide the augmentation data.
