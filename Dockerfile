...
ARG USER_NAME="eric-oss-assurance-augmentation"
...
ARG JAR_FILE
ADD target/${JAR_FILE} eric-oss-assurance-augmentation-app.jar
...
LABEL \
    org.opencontainers.image.title=eric-oss-assurance-augmentation-jsb \
