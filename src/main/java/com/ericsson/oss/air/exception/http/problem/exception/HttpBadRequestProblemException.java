 ...
 */
public class HttpBadRequestProblemException extends HttpProblemException {
    @Builder
    public HttpBadRequestProblemException(final String description, final String instance, final String type) {
